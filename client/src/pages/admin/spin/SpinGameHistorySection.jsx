...
const SpinGameHistorySection = () => {
  ...
  const columns = useMemo(
    () => [
      ...
      { field: "max_players", headerName: "Max Players", width: 130 },
      {
        ...
        headerName: "System Benefit (coins)",
        valueGetter: (value, row) =>
  ...
  const fetchRows = async ({ page, pageSize, sortModel, extraFilters }) => {
    ...
    const res = await api.get("/api/v1/spin/history", { params });
    ...
    >
      ...
      >
        <DialogTitle id="game-details-dialog-title">
          Spin-Spin Game Details (ID: {selectedGame?._id.slice(0, 8)})
        </DialogTitle>
        <DialogContent>
          {selectedGame && (
            <>
              ...
              >
                <Box>
                  ...
                  {formatCurrency(selectedGame.prize_amount)} coins
                </Box>
                <Box>
                  <strong>Bet Amount:</strong>{" "}
                  {formatCurrency(selectedGame.bet_amount)} coins
                </Box>
                <Box>
                ...
                <Box>
                  ...
                  {formatCurrency(selectedGame.system_benefit)} coins
                </Box>
                <Box>
                  <strong>Prize Structure:</strong> 1st:{" "}
                  {formatCurrency(selectedGame.prize_structure?.first)} coins,
                  ...
                  <Table sx={tableSx}>
                    <TableHead>
                      <TableRow>
                        ...
                        <TableCell>Prize (coins)</TableCell>
                      </TableRow>
                    </TableHead>
                    <TableBody>
...
export default SpinGameHistorySection;
