...
const colors = {
  deposits: { bg: "rgba(17, 110, 81, 0.5)", border: "#116e51" },
  withdrawals: { bg: "rgba(255, 59, 48, 0.5)", border: "#ff3b30" },
  bets: { bg: "rgba(255, 159, 28, 0.5)", border: "#ff9f1c" },
  rewards: { bg: "rgba(17, 110, 81, 0.5)", border: "#116e51" },
  systemEarnings: {
    bg: "rgba(17, 110, 81, 0.5)",
    border: "#116e51",
  },
  fallback: { bg: "rgba(85, 255, 119, 0.5)", border: "#55ff77" },
  games: { bg: "rgba(17, 110, 81, 0.5)", border: "#116e51" },
};

const SpinDashboardSection = ({ analytics, stats }) => {
  ...
  const chartOptions = {
    ...
    scales: {
      y: {
        beginAtZero: true,
        title: { display: true, text: "Amount (coins)" },
      },
    },
  };
  ...
  const pieChartOptions = {
    ...
    plugins: {
      ...
      tooltip: {
        callbacks: {
          label: (context) =>
            `${context.label}: ${context.parsed?.toFixed(2) || 0} coins`,
        },
      },
    },
  };
...
export default SpinDashboardSection;
