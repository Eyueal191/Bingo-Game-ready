...
import KeshAdminSidebar from "./KeshAdminSidebar";
import KeshDashboardSection from "./KeshDashboardSection";
import KeshUsersSection from "./KeshUsersSection";
import KeshGamesSection from "./KeshGamesSection";
import KeshGameHistorySection from "./KeshGameHistorySection";
import KeshTransactionsSection from "./KeshTransactionsSection";
import KeshPayoutsSection from "./KeshPayoutsSection";
      ...
      try {
        ...
        const [analyticsRes, usersRes, gamesRes, payoutsRes, statsRes] =
          await Promise.all([
            ...
            api.get("/api/v1/keshkesh", { params }),
        ...
        const errorMessage =
          err.response?.data?.error || "Failed to fetch Kesh-Kesh admin data";
        ...
        >
          ...
          {activeSection === "dashboard" && (
            <>
              ...
              <KeshDashboardSection analytics={analytics} stats={stats} />
            </>
          )}
          {activeSection === "users" && (
            <KeshUsersSection
          ...
          {activeSection === "games" && (
            <KeshGamesSection games={games} setGames={setGames} />
          )}
          {activeSection === "game_history" && <KeshGameHistorySection />}
          {activeSection === "transactions" && <KeshTransactionsSection />}
          ...
          {/* Settings removed: legacy global settings no longer used for Kesh-Kesh */}
        </Box>
      </Box>
    </motion.div>
  );
...
export default KeshAdminDashboard;
