...
const KeshKeshCard = styled(Card)(({ theme }) => ({
  background:
    "linear-gradient(155deg, rgba(16,23,36,0.96) 0%, rgba(22,32,46,0.98) 100%)",
  borderRadius: 24,
...
const GameTable = ({ games }) => {
  ...
  const handleJoin = (game) => {
    navigate(`/kesh-game-room/${game._id}`);
  };
              ...
              <KeshKeshCard key={game._id}>
                ...
                >
                  ...
                  <StatTile>
                    ...
                    <StatValue>
                      {typeof game.prize_amount === "number"
                        ? `${game.prize_amount.toFixed(2)} ብር`
                        : "--"}
                    </StatValue>
                    ...
                    game.prize_tiers.length > 0 ? (
                      ...
                      >
                        {game.prize_tiers
                          ...
                          .map((t) => (
                            <Chip
                              key={t.rank}
                              label={`${t.rank}ኛ ${tierAmount(game, t).toFixed(2)} ብር`}
                              size="small"
                              sx={{
                                backgroundColor: "rgba(248,180,0,0.14)",
                      ...
                      >
                        <span>1ኛ {game.prize_structure?.first?.toFixed(2)} ብር</span>
                        <span>2ኛ {game.prize_structure?.second?.toFixed(2)} ብር</span>
                      </Box>
                    )}
                  </StatTile>
                </Box>
